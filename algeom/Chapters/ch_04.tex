...
\parbox{4cm}{\begin{tikzpicture}[scale=0.5]
...
\parbox{6cm}{\begin{tikzpicture}[scale=0.5]
...
Оскільки точка $M$ --- це довільна точка еліпса, то вона має координати $(х,у)$. Тоді
...
\begin{wrapfigure}{l}{5cm}\begin{tikzpicture}[scale=0.5]
...
\begin{wrapfigure}{l}{5.6cm}\begin{tikzpicture}[scale=0.5]
...
Для гіперболи $\varepsilon = \frac{c}{a} = \frac{\sqrt{a^2 + b^2}}{a} = \sqrt{1+\frac{b^2}{a^2}}$,
